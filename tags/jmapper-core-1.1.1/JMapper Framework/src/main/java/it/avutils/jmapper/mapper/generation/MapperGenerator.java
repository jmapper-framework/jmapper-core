...
import it.avutils.jmapper.mapper.generation.beans.Constructor;
import it.avutils.jmapper.mapper.generation.beans.Field;
...
public class MapperGenerator {
	 ...
	 */
	public static Class<?> generateMapperClass(MappingBuilder mapping, Set<Method> methodsToGenerate) throws NotFoundException, Exception{
		
		// adds empty constructor
		ArrayList<Constructor> constructors = add(new ArrayList<Constructor>(),new Constructor());
