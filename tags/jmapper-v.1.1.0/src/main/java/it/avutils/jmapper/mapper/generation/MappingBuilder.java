...
import static it.avutils.jmapper.enums.MappingType.ONLY_VALUED_FIELDS;
import static it.avutils.jmapper.enums.NullPointerControl.ALL;
import static it.avutils.jmapper.enums.NullPointerControl.DESTINATION;
import static it.avutils.jmapper.enums.NullPointerControl.NOT_ANY;
import static it.avutils.jmapper.enums.NullPointerControl.SOURCE;
import static it.avutils.jmapper.util.ClassesManager.isMappedInAnnotation;
...
/**
 * MappingBuilder builds all combinations of possible mappings between classes Source and Destination.<br>
 * 
...
public class MappingBuilder {
	...
	public Set<it.avutils.jmapper.mapper.generation.beans.Method> methodsToGenerate(){
   ...
   /**
	 ...
	 */
	public MappingBuilder(Class<?> aDestination, Class<?> aSource,String aStringOfSetDestination,String aStringOfGetDestination,String aStringOfGetSource,ChooseConfig cc, XML xml, Set<Method>	methodsToGenerate) {
	 ...
	 */
    public MappingBuilder(Class<?> aDestination, Class<?> aSource,ChooseConfig configChoice, XML xml,Set<Method> methodsToGenerate){
