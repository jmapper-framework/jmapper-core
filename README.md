...
> Version 1.6.1.RC1 Released! You can check the [release notes](https://github.com/jmapper-framework/jmapper-core/wiki/Release-Notes) for more information. Just a little patience, the wiki is being updated
