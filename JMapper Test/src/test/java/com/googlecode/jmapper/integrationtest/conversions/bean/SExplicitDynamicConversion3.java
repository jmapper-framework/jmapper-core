...
public class SExplicitDynamicConversion3 {
	...
	public static String nullConversion(){
		return "${destination.type} dep = ${source}.toString();"+
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SExplicitDynamicConversion3 other = (SExplicitDynamicConversion3) obj;
		if (source == null) {
	 ...
	 * @param source4
	 */
	public SExplicitDynamicConversion3(String source, String source2,
