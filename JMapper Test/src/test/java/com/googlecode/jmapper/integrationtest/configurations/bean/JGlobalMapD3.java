...
public class JGlobalMapD3 {
	
	@JMap("notUsed")private String field;
	private String field2;
	private String field3;
	
	public JGlobalMapD3() {}
	
	public JGlobalMapD3(String field, String field2, String field3) {
		super();
		this.field = field;
		this.field2 = field2;
		this.field3 = field3;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JGlobalMapD3 other = (JGlobalMapD3) obj;
		if (field == null) {
			if (other.field != null)
				return false;
