...
/**
 * This Operation converts Calendar to Date type.
 * @author Alessandro Vurro
 *
 */
public class DateCalendarOperation extends AComplexOperation {
	...
	private StringBuilder sharedMapping(){
		return write(setDestination(write(getSource(),".getTime()")));
	}
