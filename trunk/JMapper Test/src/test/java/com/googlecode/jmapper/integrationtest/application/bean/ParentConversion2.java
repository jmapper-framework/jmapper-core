...
public class ParentConversion2 {

	@JMap	private String commonField1;
	@JMap	private String commonField2;
	
	@JMapConversion(from={"commonField1"},type=Type.DYNAMIC)
	public static String conversion(){
		return "return \"${destination.name}  = \" +${source}+ \" (${source.name} value) ANNOTATED CONVERSION\";";
	}
	...
	public ParentConversion2() {}
	/**
	 * @param commonField1
	 * @param commonField2
	 */
	public ParentConversion2(String commonField1, String commonField2) {
		super();
		this.commonField1 = commonField1;
		this.commonField2 = commonField2;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ParentConversion2 other = (ParentConversion2) obj;
